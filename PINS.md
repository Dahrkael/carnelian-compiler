...
- `0.2.0` (tag `v0.2.0`): same tuple; adds the real-world corpus tranche (264 files, mruby + picoruby, `carnelian corpus` + baseline gate): `super` splat/block/kwarg arms, circular-arg defaults, MRI numbered blocks, nested-heredoc splits, `<<~` mixed/backslash dedent.
