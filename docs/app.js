...
const EXAMPLES = [{"name":"arith","source":"puts 1 + 2 * 3\n"},{"name":"branches","source":"if true then puts 1 else puts 2 end\n"},{"name":"compare","source":"puts(1 < 2)\nputs(1 == 1)\n"},{"name":"hello","source":"puts \"hello\"\n"},{"name":"inspect","source":"p 42\n"},{"name":"loop","source":"i = 0\nwhile i < 3 do i = i + 1 end\nputs i\n"},{"name":"vars","source":"x = 6 * 7\nputs x\n"}];
